...
Las capturas deben almacenarse en la carpeta `/evidence`. Cada nombre de la tabla es un hipervínculo relativo a la imagen correspondiente dentro del repositorio.
